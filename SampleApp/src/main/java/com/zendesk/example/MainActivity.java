...
public class MainActivity extends FragmentActivity {
    ...
    public static final String EXTRA_ZENDESK_URL = "zendesk_url";
    public static final String EXTRA_ZENDESK_APPLICATION_ID = "application_id";
    public static final String EXTRA_ZENDESK_OAUTH_CLIENT_ID = "oauth_client_id";

    public static final String EXTRA_AUTHENTICATION_TYPE = "authentication_type";
